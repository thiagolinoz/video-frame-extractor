...
public class KafkaConfig {
    ...
    @Bean
    public ConsumerFactory<String, VideoMessage> consumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, VideoMessage> kafkaListenerContainerFactory() {
